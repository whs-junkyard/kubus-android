	...
	LocationListener, GoogleApiClient.ConnectionCallbacks
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		locClient = new GoogleApiClient.Builder(getActivity().getApplicationContext())
	...
	private void processData(){
    	...
    	Location location = LocationServices.FusedLocationApi.getLastLocation(locClient);
    	while(keys.hasNext()){
        	try{
	...
	public void onConnected(Bundle connectionHint) {
        ...
        LocationServices.FusedLocationApi.requestLocationUpdates(locClient, req, this);
